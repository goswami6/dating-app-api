 ...
 *                         $ref: '#/components/schemas/Badge'
 */
router.get('/users/:userId', authMiddleware, badgeController.getUserBadges);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/users/:userId', authMiddleware, badgeController.assignBadge);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete('/users/:userId/:badgeId', authMiddleware, badgeController.removeBadge);
