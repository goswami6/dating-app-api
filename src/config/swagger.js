        ...
        components: {
            ...
            schemas: {
                ...
                ShopCategory: {
                    ...
                    properties: {
                        id: { type: 'integer', example: 1 },
                        name: { type: 'string', example: 'Gifts & Flowers' },
                        slug: { type: 'string', example: 'gifts-flowers' },
                        description: { type: 'string', example: 'Perfect gifts for your special someone' },
                ...
                ShopProduct: {
                    ...
                    properties: {
                        ...
                        name: { type: 'string', example: 'Red Rose Bouquet' },
                        slug: { type: 'string', example: 'red-rose-bouquet-1719312000' },
                        price: { type: 'number', example: 799 },
                        compareAtPrice: { type: 'number', example: 999 },
                        currency: { type: 'string', example: 'INR' },
                        images: { type: 'array', items: { type: 'string' } },
                        thumbnail: { type: 'string' },
                        sku: { type: 'string', example: 'ROSE-RED-12' },
                ...
                ShopAddress: {
                    ...
                    properties: {
                        ...
                        fullName: { type: 'string', example: 'Akanksha Sharma' },
                        phone: { type: 'string', example: '+919876543210' },
                        addressLine1: { type: 'string', example: '42, Rose Garden' },
                ...
                ShopOrder: {
                    ...
                    properties: {
                        id: { type: 'integer', example: 1 },
                        orderNumber: { type: 'string', example: 'ORD-1719312000000-A3B5' },
                        status: { type: 'string', enum: ['pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled', 'returned', 'refunded'] },
                        paymentMethod: { type: 'string', enum: ['cod', 'upi', 'card', 'wallet', 'net_banking'] },
                        paymentStatus: { type: 'string', enum: ['pending', 'paid', 'failed', 'refunded'] },
                        subtotal: { type: 'number', example: 1598 },
                        discount: { type: 'number', example: 0 },
                        shippingCharge: { type: 'number', example: 0 },
                        tax: { type: 'number', example: 287.64 },
                        totalAmount: { type: 'number', example: 1885.64 },
                        currency: { type: 'string', example: 'INR' },
                        Items: {
                            type: 'array',
                            items: {
